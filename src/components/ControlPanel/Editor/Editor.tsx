...
import { swapSectionsOrder, addSectionToPage, deleteSection } from "@/app/actions/editor";
    ...
    return (
        <div className="site-editor">
            ...
            <div className="editor-main-panel">
                ...
                {currentPageId && (
                    <div className="editor-controls-panel mt-4 p-4 border border-dashed border-gray-300 rounded-xl">
                        <h4>+ Быстрое добавление секций:</h4>
